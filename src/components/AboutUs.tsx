...
function AboutUs() {
  ...
  return (
    ...
    <div className='relative h-auto w-full  bg-background text-foreground'>
      ...
      <div className="w-full bg-background h-[100vh] grid grid-rows-2 lg:h-[80vh] md:grid-rows-none md:grid-cols-2">
          <div className='h-full w-full bg-background flex justify-center items-center flex-col'>
            ...
            <p className='w-3/4 h-2/4 text-xl sm:h-2/4 lg:text-2xl'>We are not just another financial lending company providing loans. Our mission and our business is aimed at helping consumers, via strong installer relationships, that want to make a statement with their homes. Whether that statement is a new renovation or going renewable with solar panels, we are here to provide the support and financing to make the dream a reality. <br></br>
            Embrace the changemaker mindset. <Link className="text-xl lg:text-2xl" href="#">You’ve got this.</Link></p>
          </div>
